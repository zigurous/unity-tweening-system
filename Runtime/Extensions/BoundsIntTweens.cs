...
namespace Zigurous.Animation.Tweening
{
    public static class BoundsIntTweens
    {
        ...
        public static Tween TweenPosition(this BoundsInt bounds, Vector3Int to, float duration) =>
            Tweener.To(getter: () => bounds.position,
